...
#SBATCH --output="test_c3.out"
#SBATCH --error="test_c3.err"
...
cp ${param_dir}/case_c3.txt case.txt
cp ${param_dir}/params1_hwsd_${case}.txt params1.txt
cp ${param_dir}/params_val_${case}.txt params_val.txt
...
ifort -o runsoc model5.f90 -L/apps/netcdf/4.8.1-intel20/lib/Intel -lnetcdff -lnetcdf -qopenmp
export OMP_NUM_THREADS=8

./runsoc >output/outval_${case}.txt
